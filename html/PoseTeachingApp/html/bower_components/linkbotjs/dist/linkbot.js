...
var SliderControl = React.createClass({displayName: "SliderControl",
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: className, style: style, ref: "slider", 
                onClick: this.handleMouseEvent, 
                onMouseMove: this.handleMouseMove, 
                onMouseDown: this.handleMouseDown, 
                onMouseUp: this.handleMouseUp}, 
                React.createElement("span", {className: classNameHandle, ref: "handle"})
            )
        )
    }
...
var RobotItem = React.createClass({displayName: "RobotItem",
    propTypes: {
...
var AddRobotForm = React.createClass({displayName: "AddRobotForm",
    ...
    render:function() {
        return (
            React.createElement("div", {id: "ljs-add-robot-form"}, 
...
var Robots = React.createClass({displayName: "Robots",
    componentWillMount: function() {
        var me = this;
    ...
    render:function() {
        ...
        var robotItems = this.state.robots.map(function(robot, i) {
           return React.createElement(RobotItem, {"data-id": i, key: robot.id, linkbot: robot, draggable: "true", onDragEnd: me.dragEnd, onDragStart: me.dragStart});
        });
        return (
            React.createElement("ol", {onDragOver: this.dragOver}, 
                robotItems
            )
        );
    ...
    render: function() {
        return (
            React.createElement("div", null, 
                React.createElement("div", {id: "ljs-overlay", ref: "overlay", onClick: this.hideAll}), 
                React.createElement("div", {id: "ljs-control-panel", ref: "controlPanel"}, 
                    React.createElement("div", {className: "ljs-control-header"}, 
                        React.createElement("div", {className: "ljs-control-title"}, 
                            React.createElement("h1", null, "Linkbot ", this.state.title)
                        )
                    ), 
                    React.createElement("div", {className: "ljs-row"}, 
                        React.createElement("div", {className: "ljs-control-col"}, 
                            ...
                            React.createElement("div", {className: "ljs-control-poster"}, 
                                React.createElement("div", {className: "ljs-btn-group"}, 
                                    React.createElement("button", {className: "ljs-btn-up joint-control-btn", onClick: this.motor1Up}, "joint 1 up"), 
                                    React.createElement("button", {className: "ljs-btn-stop joint-control-btn", onClick: this.motor1Stop}, "joint 1 stop"), 
                                    React.createElement("button", {className: "ljs-btn-down joint-control-btn", onClick: this.motor1Down}, "joint 1 down")
                                ), 
                                React.createElement("div", {className: "ljs-btn-group"}, 
                                    React.createElement("button", {className: "ljs-btn-up joint-control-btn", onClick: this.motor2Up}, "joint 2 up"), 
                                    React.createElement("button", {className: "ljs-btn-stop joint-control-btn", onClick: this.motor2Stop}, "joint 2 stop"), 
                                    React.createElement("button", {className: "ljs-btn-down joint-control-btn", onClick: this.motor2Down}, "joint 2 down")
                                )
                            ), 
                            React.createElement("div", {className: "ljs-control-poster"}, 
                                React.createElement("div", null, 
                                    React.createElement("button", {className: "drive-control-btn-sm ljs-btn-up", onClick: this.driveForward}, "up")
                                ), 
                                React.createElement("div", null, 
                                    React.createElement("button", {className: "drive-control-btn-sm ljs-btn-left", onClick: this.driveLeft}, "left"), 
                                    React.createElement("button", {className: "drive-control-btn-sm ljs-btn-down", onClick: this.driveDown}, "down"), 
                                    React.createElement("button", {className: "drive-control-btn-sm ljs-btn-right", onClick: this.driveRight}, "right")
                                ), 
                                React.createElement("div", null, 
                                    React.createElement("button", {className: "drive-control-btn-lg ljs-btn-zero", onClick: this.driveZero}, "zero")
                                ), 
                                React.createElement("div", null, 
                                    React.createElement("button", {className: "drive-control-btn-lg ljs-btn-stop", onClick: this.driveStop}, "stop")
                                )
                            )
                        ), 
                        React.createElement("div", {className: "ljs-control-col"}, 
                            React.createElement("div", {className: "ljs-control-poster"}, 
                                ...
                                React.createElement("div", {className: "ljs-btn-group", onClick: this.beepButton}, 
                                    React.createElement("span", {className: "ljs-beep-btn"}, "beep")
                                )
                            ), 
