...
PropertyAccessor = (function() {
  ...
  function PropertyAccessor(definition, object) {
    ...
    this.trigger = function() {
      return PropertyAccessor.prototype.trigger.apply(_this, arguments);
    };
  ...
  PropertyAccessor.prototype.registerGlobal = function(value) {
    ...
    this.definition.globalDependencies.forEach(function(_arg) {
  ...
  def(PropertyAccessor.prototype, "hasListeners", {
    get: function() {
      var _this = this;
      return this.listeners.length === 0 && !this.dependentProperties.find(function(prop) {
